            ...
            <div key={index} className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
              <a href="#">
                ...
                <div className="px-4 py-3 w-72">
                  <span className="text-gray-400 mr-3 uppercase text-xs">100% nature</span>
                  <p className="text-lg font-bold text-black truncate block capitalize">{product.name}</p>
                  <div className="flex items-center">
                    <p className="font-timesNewLightItalic  text-lg font-semibold text-black cursor-auto my-3">{product.price}</p>
