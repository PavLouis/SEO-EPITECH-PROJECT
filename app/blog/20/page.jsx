  ...
  return (
    <div>
      <BlogComponent blogInformation={blogInfo}>
        ...
        <p className="py-3 text-xl">
          Take a moment for yourself with Andarduft Tea. Its calming effects and soothing flavors make it a perfect tool for managing stress, finding balance, and staying centered throughout the day.
        </p>
      </BlogComponent>
    </div>
  );
